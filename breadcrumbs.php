...
if ($showOnHome == 1) echo '<ul id="bc1 class="breadcrumb"><li><a href="' . $homeLink . '">' . $home . '</a></li></ul>';

} else {

echo '<ul id="bc1" class="breadcrumb"><li><a href="' . $homeLink . '">' . $home . '</a></li> ';
...
echo $breadcrumbs[$i];
if ($i != count($breadcrumbs)-1) echo ' </li> ';
}
if ($showCurrent == 1) echo ' </li> ' . $before . get_the_title() . $after;
