...
function general_map($atts) {
    extract(shortcode_atts( array(
      'location' => 'Hitt',
      'title' => 'John C. Hitt Library Google Map',
  ), $atts ));
  switch ($location) {
    case '':
    ...
    case 'Rosen':
      ...
      $title = 'Rosen Library Google Map';
      break;
    case 'CMC':
    ...
    case 'Altamonte':
      ...
      $title = 'Altamonte Library Google Map';
      break;
    case 'Cocoa':
      ...
      $title = 'Cocoa Library Google Map';
      break;
    case 'Daytona':
      ...
      $title = 'Daytona Library Google Map';
      break;
    case 'COM':
      ...
      $title = 'College of Medicine Library Google Map';
      break;
    case 'Leesburg':
      ...
      $title = 'Leesburg Library Google Map';
      break;
    case 'Ocala':
      ...
      $title = 'Ocala Library Google Map';
      break;
    case 'Palm Bay':
      ...
      $title = 'Palm Bay Library Google Map';
      break;
    case 'Sanford':
      ...
      $title = 'Sanford Library Google Map';
      break;
    case 'South Lake':
      ...
      $title = 'South Lake Library Google Map';
      break;
    case 'Valencia Osceola':
      ...
      $title = 'Valencia Osoceola Library Google Map';
      break;
    case 'Valencia West':
  ...
  $output = '<div class="google-maps"> <iframe src="'.$src.'" width="600" height="450" frameborder="0" style="border:0" title="'.$title.'"></iframe> </div>';
  return $output;
}
    ...
    if (!empty( $json_o->data->childCounts)) {
      foreach ($json_o->data->childCounts as $floor) {
        if ($floor->isActive !== false) {
          ...
          $output .= '<div id="id_'.$floor->id.'" class="grid-item"><div class="card '.$busy_class.' busy-card">';
          ...
          $output .= '<div class="progress">
									     <div id="occupancy_bar" class="progress-bar '.$progress_color.'" role="progressbar" aria-valuenow="'.$percent_occupied.'" aria-valuemin="0" aria-valuemax="100" style="width: '.$percent_occupied.'%;">
									     </div>
									    </div>';
          $output .= '</div></div>';
        }
